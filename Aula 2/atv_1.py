...
if seu_nome == "Finn" or seu_nome == "Jake":
...
print("Entendi!")
nome_princesa_bonita = input("Ei, qual princesa desse mundo é a mais bonita pra você? ")
if nome_princesa_bonita == "Princesa de Fogo" or nome_princesa_bonita == "Princesa Jujuba":
